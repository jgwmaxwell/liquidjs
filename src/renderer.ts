...
export class Renderer {
  public async renderTemplates(templates: Template[], scope: Scope, writer: Writeable): Promise<void> {
    await Promise
      .all(templates.map(template =>
        this
          .renderTemplate(template, scope, writer)
          .catch((err: Error) => {
  ...
  public renderTemplate = async (template: Template, scope: Scope, writer: Writeable): Promise<void> => {
  ...
  public async renderTag(template: ControlTemplate | TagInstance, scope: Scope, writer: Writeable): Promise<void> {
  ...
  public async evalOutput(template: OutputTemplate, scope: Scope, writer: Writeable): Promise<void> {
